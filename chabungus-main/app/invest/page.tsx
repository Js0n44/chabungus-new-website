            ...
            <div className="w-full max-w-4xl space-y-12">
                ...
                <div className="space-y-6 text-center">
                    ...
                    <p className="text-base sm:text-lg text-zinc-300 max-w-2xl mx-auto">
                        If you have a cool game that's just not doing too well, Chabungus LLC may provide ad funding, marketing strategy, and onboarding/gameplay optimization, and other stuff in exchange for equity or ownership percentage. "Releasing" a game is only just the beginning. We help with what's next.
                    </p>
                </div>
